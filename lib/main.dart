    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        appBarTheme: const AppBarTheme(
          backgroundColor: Color.fromARGB(255, 0, 26, 1), // AppBarの背景色を緑色に設定します。
          titleTextStyle: TextStyle(color: Colors.white), // AppBarのタイトルのテキストスタイル
        ),
        // FloatingActionButtonのテーマをカスタマイズします。
        floatingActionButtonTheme: const FloatingActionButtonThemeData(
          backgroundColor: Color.fromARGB(255, 1, 0, 31), // FloatingActionButtonの背景色
        ),
        // テキストのテーマをカスタマイズします。
